                                   ...
                                   SystemParameters &systemParameters)
{
    ...
    for (int i = 0; i < 3; i++)
        localRightPart.setElement(i, (
                                         (1.0 / (3.0 * poisC2 * poisC2)) * c[i] * poisC1 * (-3.0 * k1 * (k2 * k2 * poisC2 * poisC2 + 2.0 * k1 * k2 * poisC2 * poisC2 * si + k1 * k1 * (-2.0 + poisC2 * poisC2 * si * si)) * cos(poisC2 * si) + 3.0 * k1 * (k2 * k2 * poisC2 * poisC2 + 2 * k1 * k2 * poisC2 * poisC2 * sk + k1 * k1 * (-2.0 + poisC2 * poisC2 * sk * sk)) * cos(poisC2 * sk) + poisC2 * (-(3.0 * k1 * k2 * k2 * poisC2 * poisC2 * si + k1 * k1 * k1 * si * (-6.0 + poisC2 * poisC2 * si * si) + 3.0 * k1 * k1 * k2 * (-2.0 + poisC2 * poisC2 * si * si) + poisC2 * poisC2 * (k2 * k2 * k2 - zi * zi * zi)) * sin(poisC2 * si) + (3.0 * k1 * k2 * k2 * poisC2 * poisC2 * sk + k1 * k1 * k1 * sk * (-6.0 + poisC2 * poisC2 * sk * sk) + 3 * k1 * k1 * k2 * (-2.0 + poisC2 * poisC2 * sk * sk) + poisC2 * poisC2 * (k2 * k2 * k2 - zi * zi * zi)) * sin(poisC2 * sk))) +
                                         0.5 * poisC1 * poisC2 * poisC2 * (-(1.0 / (poisC2 * poisC2 * poisC2 * poisC2)) * ((2 * a[i] * k1 * poisC2 * poisC2 * (k2 + k1 * si) + b[i] * (4.0 * k1 * k2 * poisC2 * poisC2 * si + 3.0 * k1 * k1 * (-2.0 + poisC2 * poisC2 * si * si) + poisC2 * poisC2 * (k2 * k2 - zi * zi))) * cos(poisC2 * si) + poisC2 * (a[i] * (2.0 * k1 * k2 * poisC2 * poisC2 * si + k1 * k1 * (-2.0 + poisC2 * poisC2 * si * si) + poisC2 * poisC2 * (k2 * k2 - zi * zi)) + b[i] * (k1 * k1 * si * (-6.0 + poisC2 * poisC2 * si * si) + 2.0 * k1 * k2 * (-2.0 + poisC2 * poisC2 * si * si) + poisC2 * poisC2 * si * (k2 * k2 - zi * zi))) * sin(poisC2 * si)) + 1.0 / (poisC2 * poisC2 * poisC2 * poisC2) * ((2.0 * a[i] * k1 * poisC2 * poisC2 * (k2 + k1 * sk) + b[i] * (4.0 * k1 * k2 * poisC2 * poisC2 * sk + 3.0 * k1 * k1 * (-2.0 + poisC2 * poisC2 * sk * sk) + poisC2 * poisC2 * (k2 * k2 - zi * zi))) * cos(poisC2 * sk) + poisC2 * (a[i] * (2 * k1 * k2 * poisC2 * poisC2 * sk + k1 * k1 * (-2.0 + poisC2 * poisC2 * sk * sk) + poisC2 * poisC2 * (k2 * k2 - zi * zi)) + b[i] * (k1 * k1 * sk * (-6.0 + poisC2 * poisC2 * sk * sk) + 2.0 * k1 * k2 * (-2.0 + poisC2 * poisC2 * sk * sk) + poisC2 * poisC2 * sk * (k2 * k2 - zi * zi))) * sin(poisC2 * sk)))));
